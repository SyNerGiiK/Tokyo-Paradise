...
function getParkingPosition(spots)
  ...
  TriggerEvent('chatMessage', '^1Spawn point de vehicule occupé - Merci de patienter.')
 end
...
function playerIsOnJobVehicle()
	return IsVehicleModel(GetVehiclePedIsIn(PlayerPedId(), false), GetHashKey("boxville4"))
end
