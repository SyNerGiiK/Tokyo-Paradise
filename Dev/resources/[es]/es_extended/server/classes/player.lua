function CreateExtendedPlayer(player, accounts, inventory, job, loadout, name, lastPosition)
	...
	self.removeInventoryItem = function(name, count)
		...
		TriggerClientEvent('secureesx:removeInventoryItem', self.source, item, count)
	end
	...
	self.setInventoryItem = function(name, count)
		...
		if oldCount > item.count  then
			...
			TriggerClientEvent('secureesx:removeInventoryItem', self.source, item, oldCount - item.count)
		else
	...
	self.removeWeapon = function(weaponName, ammo)
		...
		if weaponLabel then
			...
			TriggerClientEvent('secureesx:removeInventoryItem', self.source, {label = weaponLabel}, 1)
		end
	end
