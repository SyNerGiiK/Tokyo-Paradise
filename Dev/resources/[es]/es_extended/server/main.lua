...
RegisterServerEvent('secureesx:giveInventoryItem')
AddEventHandler('secureesx:giveInventoryItem', function(target, type, itemName, itemCount)
	local _source = source
...
RegisterServerEvent('secureesx:removeInventoryItem')
AddEventHandler('secureesx:removeInventoryItem', function(type, itemName, itemCount)
	local _source = source
